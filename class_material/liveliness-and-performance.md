...
livelock-small.jpglivelock.jpg
...
The dining philosophers problem captures many aspects of liveness in concurrent environments in a vivid metaphor. Consider the following image:
http://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Dining_philosophers.png/578px-Dining_philosophers.png
...
Request all resources atomically - Each thread asks for all its needed resources atomically. This is done by adding another lock (a semaphore initiated to 1) known to all the philosophers, which they must grab before trying to grab any fork and release once they have grabbed both forks.
