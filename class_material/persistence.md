...
This SQL Code Example shows how the model is encoded in SQL. You can execute this SQL code by using the HsqlDb software discussed in this practical session.